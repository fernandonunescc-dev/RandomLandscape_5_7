...
{
	// Mountain terrain: dramatic peaks and ridges
...
float FMountainTerrainGenerator::FractalNoise(float NormX, float NormY, const FBiomeMeshSettings& MeshSettings, int32 Seed, float MapSizeInMeters) const
{
	float Total = 0.0f;
