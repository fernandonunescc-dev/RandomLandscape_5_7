...
{
	// Snow terrain: icy peaks and frozen valleys
...
float FSnowTerrainGenerator::FractalNoise(float NormX, float NormY, const FBiomeMeshSettings& MeshSettings, int32 Seed, float MapSizeInMeters) const
{
	float Total = 0.0f;
